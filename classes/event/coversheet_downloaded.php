 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class coversheet_downloaded extends \mod_assign\event\submission_updated {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has downloaded their cover sheet for submission " .
    ...
    public static function get_name() {
        return get_string('eventcoversheetdownloaded', 'assignsubmission_physical');
    }
