...
// SU_AMEND START - Assignment (physical): Prevent draft submissions when printing barcodes
...
// SU_AMEND END
            ...
            if (! $record = $DB->get_record('assignsubmission_barcode', array('submissionid' => $submission->id))) {
                ...
                $DB->insert_record('assignsubmission_barcode', $assignsubmissionbarcode);
            }
        }
    }
    ...
    private function set_coursestudent_submission_details() {
        ...
        $studentsql = "
                SELECT u.id, u.firstname, u.lastname, u.email,
                       ...
                       b.barcode
                  FROM {user} u
                  JOIN {assignsubmission_barcode} b ON u.id = b.userid AND b.assignmentid = ?
    ...
    public function generate_pdf_content() {
        ...
        $pdf->AddPage();
        $content .= $this->generate_pdf_table_header();
